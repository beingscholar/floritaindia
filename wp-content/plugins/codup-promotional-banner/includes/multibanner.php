					...
					<div class="quoteContainer">
						<p class="quote-phrase margin-zero"  style="font-size: <?php echo esc_html( $general_settings['font_size'] ); ?>;" > 
							<?php if ( 'call-to-action' === $banner_settings['url_action'] ) { ?>
									<a  style=" color:<?php echo esc_html( $general_settings['font-color'] ); ?>;"><span class="quote-marks"><?php echo esc_html( $bannners_text ); ?></span></a>
									<a href="<?php echo esc_url( $banner_settings['bannerurl'] ); ?> ">
									<input type="submit" style="font-size: <?php echo esc_html( $button_font_size . 'px' ); ?>;"   style="font-size: <?php echo esc_html( $general_settings['font_size'] ); ?>;" id="submit" value="<?php echo esc_attr( $banner_settings['button_text'] ); ?>" >
									</a>
									<?php
							} else {
								if($banner_settings['bannerurl'] === ""){
									?>
									<a class="pointer-event-css" href="<?php echo esc_url( $banner_settings['bannerurl'] ); ?> "  style="color:<?php echo esc_html( $general_settings['font-color'] ); ?>;"><span class="quote-marks"><?php echo esc_html( $bannners_text ); ?></span></a>
									<?php
								}else{
									?>
									<a href="<?php echo esc_url( $banner_settings['bannerurl'] ); ?> "  style=" color:<?php echo esc_html( $general_settings['font-color'] ); ?>;"><span class="quote-marks"><?php echo esc_html( $bannners_text ); ?></span></a>
									<?php
								}
							}
							?>
